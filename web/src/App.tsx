        ...
        <div className="max-w-[1344px] mx-auto flex items-center flex-col my-20">
            ...
            <div className="grid grid-cols-6 gap-6 mt-6">
                <a href="" className="relative rounded-lg overflow-hidden">
                    <img src="/public/assets/games/game-1.png" alt="" />
                ...
                <a href="" className="relative rounded-lg overflow-hidden">
                    <img src="/public/assets/games/game-2.png" alt="" />
                ...
                <a href="" className="relative rounded-lg overflow-hidden">
                    <img src="/public/assets/games/game-3.png" alt="" />
                ...
                <a href="" className="relative rounded-lg overflow-hidden">
                    <img src="/public/assets/games/game-4.png" alt="" />
                ...
                <a href="" className="relative rounded-lg overflow-hidden">
                    <img src="/public/assets/games/game-5.png" alt="" />
                ...
                <a href="" className="relative rounded-lg overflow-hidden">
                    <img src="/public/assets/games/game-6.png" alt="" />
